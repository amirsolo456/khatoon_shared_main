...
class AppPalette {
  ...
  // Light Theme Colors (Monochrome/Minimalist)
  ...
  // Status Colors (Grayscale scheme)
  static const Color success = Color(0xFF475569);
  static const Color successLight = Color(0xFFF1F5F9);
  static const Color successDark = Color(0xFF1E293B);

  static const Color warning = Color(0xFFCBD5E1);
  static const Color warningLight = Color(0xFFF8FAFC);
  static const Color warningDark = Color(0xFF94A3B8);

  static const Color error = Color(0xFF64748B);
  static const Color errorLight = Color(0xFFF1F5F9);
  static const Color errorDark = Color(0xFF334155);

  static const Color info = Color(0xFF94A3B8);
  static const Color infoLight = Color(0xFFF1F5F9);
  static const Color infoDark = Color(0xFF64748B);
